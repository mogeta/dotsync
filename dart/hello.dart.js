...
$$.HashSetIterator = {"": "Object;_liblib$_set,_elements,_offset,_liblib$_current",
  get$current: function() {
    return this._liblib$_current;
  },
  moveNext$0: function() {
...
$$.Object = {"": ";",
  ...
  onClose$0: function($receiver) {
    return this.noSuchMethod$1(this, $.createInvocationMirror("onClose", "onClose$0", 0, [], []));
  },
  onError$2: function($receiver, $0, $1) {
    return this.noSuchMethod$1(this, $.createInvocationMirror("onError", "onError$2", 0, [$0, $1], []));
  },
  onMessage$1: function($receiver, $0) {
    return this.noSuchMethod$1(this, $.createInvocationMirror("onMessage", "onMessage$1", 0, [$0], []));
  },
  onOpen$0: function($receiver) {
    return this.noSuchMethod$1(this, $.createInvocationMirror("onOpen", "onOpen$0", 0, [], []));
  },
...
$$._JsSendPortSync = {"": "Object;_liblib3$_id",
  ...
  $eq: function(_, other) {
    if (other == null)
      return false;
    return typeof other === "object" && other !== null && !!$.getInterceptor(other).$is_JsSendPortSync && $.$eq(this._liblib3$_id, other._liblib3$_id) === true;
  },
  get$hashCode: function(_) {
...
$$._Serializer0 = {"": "_MessageTraverser0;",
  ...
  _liblib3$_serializeList$1$bailout: function(state0, list, t1, len) {
    switch (state0) {
      case 0:
      case 1:
        state0 = 0;
...
$$._Deserializer0 = {"": "Object;",
  ...
  _liblib3$_deserializeMap$1$bailout: function(state0, x, result, keys, t1, values, t3, len) {
    switch (state0) {
      case 0:
        result = $.HashMap$();
        t1 = $.getInterceptor$asx(x);
...
$$.main_anon = {"": "Closure;box_0",
  call$0: function() {
    var token, t1;
    if ($.$eq($._depth(), 0) === true)
      $.throwExpression("Cannot get JavaScript context out of scope.");
    token = $._deserialize($._jsPortSync.callSync$1([])).get$token();
    t1 = this.box_0;
    t1.token_0 = token;
    if ($.$eq($._depth(), 0) === true)
      $.throwExpression("Cannot get JavaScript context out of scope.");
    t1.meID_1 = $._deserialize($._jsPortSync.callSync$1([])).get$me();
    if ($.$eq($._depth(), 0) === true)
      $.throwExpression("Cannot get JavaScript context out of scope.");
    t1.gameID_2 = $._deserialize($._jsPortSync.callSync$1([])).get$game_key();
  }
};

$$.openChannel_anon = {"": "Closure;",
  call$0: function() {
    $.Primitives_printString("open");
    return;
  }
};

$$.openChannel_anon0 = {"": "Closure;",
  call$0: function() {
...
$$.openChannel_anon1 = {"": "Closure;element_0",
  call$1: function(m) {
    var t1, t2;
    t1 = this.element_0;
    t2 = $.getInterceptor$x(t1);
    t2.set$innerHtml(t1, $.S(t2.get$innerHtml(t1)) + $.S(m) + "<br />");
    $.Primitives_printString($.S(m));
  }
};

$$.openChannel_anon2 = {"": "Closure;",
  call$2: function(code, desc) {
    $.Primitives_printString("error: " + $.S(code) + " " + $.S(desc));
    return;
  }
};

$$.setButtonListner_anon = {"": "Closure;meID_0,gameID_1",
  call$1: function(e) {
    var httpRequest = new XMLHttpRequest();
    $.open$3$async$x(httpRequest, "POST", "/receive?p=" + $.S(this.meID_0) + $.S(this.gameID_1), true);
    httpRequest.send();
  }
};

$$._subscribe_anon = {"": "Closure;handler_0",
  call$1: function(e) {
    var detail, token, socket;
    detail = $.parse($.get$detail$x(e), null);
    token = $.$index$asx(detail, "token");
    socket = $.$index$asx($._sockets, token);
    if (socket != null && $.get$onMessage$x(socket) != null)
...
$$._setup_anon0 = {"": "Closure;",
  call$2: function(s, _) {
    return $.onClose$0$x(s);
  }
};

$$._setup_anon1 = {"": "Closure;",
  call$2: function(s, d) {
    return $.onMessage$1$x(s, $.$index$asx(d, "message"));
  }
};

$$._setup_anon2 = {"": "Closure;",
  call$2: function(s, d) {
    var t1 = $.getInterceptor$asx(d);
    return $.onError$2$x(s, t1.$index(d, "code"), t1.$index(d, "description"));
  }
};

$$.Channel = {"": "Object;token<",
  open$0: function(_) {
    var t1, e, socket;
    $._setup();
    t1 = this.token;
    e = document.createEvent("CustomEvent");
    $.$$dom_initCustomEvent$4$x(e, "_open_channel", false, false, t1);
    window.dispatchEvent(e);
    socket = $.Socket$_(t1);
    $.$indexSet$ax($._sockets, t1, socket);
    return socket;
  }
};

$$.Socket = {"": "Object;_token,onOpen,onMessage>,onError,onClose",
  onOpen$0: function($receiver) {
    return this.onOpen.call$0();
  },
  onMessage$1: function($receiver, arg0) {
    return this.onMessage.call$1(arg0);
  },
  onError$2: function($receiver, arg0, arg1) {
    return this.onError.call$2(arg0, arg1);
  },
  onClose$0: function($receiver) {
    return this.onClose.call$0();
  }
};
  ...
  noSuchMethod$1: function(_, invocation) {
    ...
    if (invocation.get$isMethod() === true && $.$eq(invocation.memberName, "call") === true) {
      ...
      if ($.$eq(t1.$index(result, 0), "throws") === true)
        throw $.wrapException(t1.$index(result, 1));
...
$$.AbstractWorker = {"": "EventTarget;",
  ...
  onError$2: function($receiver, arg0, arg1) {
    return this.get$onError($receiver).call$2(arg0, arg1);
  }
};
...
$$.BodyElement = {"": "Element;",
  ...
  onMessage$1: function($receiver, arg0) {
    return this.get$onMessage($receiver).call$1(arg0);
  }
};
...
$$.EventSource = {"": "EventTarget;",
  ...
  onOpen$0: function($receiver) {
    return this.get$onOpen($receiver).call$0();
  }
};
...
$$.Notification = {"": "EventTarget;",
  ...
  onClose$0: function($receiver) {
    return this.get$onClose($receiver).call$0();
  },
  get$onError: function(receiver) {
    return $.EventStreamProvider_error.forTarget$1(receiver);
  },
...
$.main = function() {
  ...
  t1.meID_1 = null;
  t1.gameID_2 = null;
  $.scoped(new $.main_anon(t1));
  $.openChannel(t1.token_0);
  $.setButtonListner(t1.meID_1, t1.gameID_2);
};

$.openChannel = function(token) {
  var element, channel, socket;
  element = document.querySelector("#area");
  channel = $.Channel$(token);
  socket = channel.open$0(channel);
  socket.onOpen = new $.openChannel_anon();
  socket.onClose = new $.openChannel_anon0();
  socket.onMessage = new $.openChannel_anon1(element);
  socket.onError = new $.openChannel_anon2();
};

$.setButtonListner = function(meID, gameID) {
  $.get$onClick$x(document.querySelector("#button_id")).listen$1(new $.setButtonListner_anon(meID, gameID));
};

$._subscribe = function(type, handler) {
  var t1 = $.get$on$x(window);
  t1.$index(t1, type).listen$1(new $._subscribe_anon(handler));
};
...
$.Proxy__forward = function(receiver, member, kind, args) {
  ...
  if ($.get$_proxiedObjectTable().get$_scopeIndices().length === 0)
    throw $.wrapException("Cannot access a JavaScript proxy out of scope.");
...
$.onClose$0$x = function(receiver) {
  return $.getInterceptor$x(receiver).onClose$0(receiver);
};
$.onError$2$x = function(receiver, a0, a1) {
  return $.getInterceptor$x(receiver).onError$2(receiver, a0, a1);
};
$.onMessage$1$x = function(receiver, a0) {
  return $.getInterceptor$x(receiver).onMessage$1(receiver, a0);
};
$.onOpen$0$x = function(receiver) {
  return $.getInterceptor$x(receiver).onOpen$0(receiver);
};
...
function init() {
  ...
  Isolate.$finishClasses = function(collectedClasses, isolateProperties, existingIsolateProperties) {
    ...
    var objectClassObject = collectedClasses.Object, shortNames = "call$0,call$1,call$2,call$3,call$4,eval$1,get$me,get$sb,then$1,get$_id,get$_key,get$_set,get$_tag,lookup$1,toJson$0,get$_next,get$token,process$0,set$_next,callSync$1,get$_state,get$_value,moveNext$0,set$_state,set$_value,_callback$2,_dispatch$1,_sendData$1,exitScope$0,get$current,set$_handle,_sendError$1,_sendValue$1,catchError$1,enterScope$0,get$game_key,get$isWorker,get$sendPort,toSendPort$0,unregister$1,_setGlobals$0,get$_callback,get$_duration,get$_previous,get$_registry,get$_workerId,set$_previous,get$_isolateId,runIteration$0,_checkReplyTo$1,get$_futurePort,get$_receivePort,get$topEventLoop,get$_nextListener,get$_scopeIndices,get$nextIsolateId,set$_nextListener,set$nextIsolateId,get$currentContext,_liblib3$_callback$1,get$_hasUnhandledError,get$_resultOrListeners".split(","), longNames = "call,call,call,call,call,eval,me,sb,then,_id,_key,_set,_tag,lookup,toJson,_next,token,process,_next=,callSync,_state,_value,moveNext,_state=,_value=,_callback,_dispatch,_sendData,exitScope,current,_handle=,_sendError,_sendValue,catchError,enterScope,game_key,isWorker,sendPort,toSendPort,unregister,_setGlobals,_callback,_duration,_previous,_registry,_workerId,_previous=,_isolateId,runIteration,_checkReplyTo,_futurePort,_receivePort,topEventLoop,_nextListener,_scopeIndices,nextIsolateId,_nextListener=,nextIsolateId=,currentContext,_callback,_hasUnhandledError,_resultOrListeners".split(",");
